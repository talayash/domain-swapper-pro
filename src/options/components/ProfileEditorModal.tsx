...
function SortableEntry({
  ...
  return (
    <div ref={setNodeRef} style={style} className="flex items-start gap-2 p-2 rounded-md border bg-card">
      <button className="mt-2 cursor-grab active:cursor-grabbing p-0.5 opacity-50 hover:opacity-100" {...attributes} {...listeners}>
        <GripVertical className="h-3.5 w-3.5 text-muted-foreground" />
      </button>

      <div className="flex-1 grid grid-cols-[1fr_1fr_auto_auto] gap-2 items-start">
        <div>
          <input
            type="text"
            value={entry.url}
        ...
        <div>
          <select
            ...
            className="input text-sm w-[120px]"
          >
        ...
        <div>
          <select
            ...
            className="input text-sm w-[100px]"
          >
      ...
      {showRemove && (
        <button
          ...
          className="mt-1.5 p-1.5 rounded-md hover:bg-destructive/10 hover:text-destructive transition-colors"
        >
  ...
  return (
    <Dialog.Root open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-background rounded-lg shadow-lg p-5 w-[680px] max-h-[85vh] overflow-y-auto border border-border animate-fade-in">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="text-xs text-muted-foreground grid grid-cols-[28px_1fr_1fr_120px_100px_32px] gap-2 px-2 mb-1">
                <span></span>
                <span>URL</span>
                <span>Label</span>
                <span>Role</span>
